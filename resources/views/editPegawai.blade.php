...
<head>
    ...
    <style>
        ...
        .btn-update { background-color: #0d6efd; color: white; }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-body p-4">
                ...
                <h4 class="card-title mb-4">Edit Data Karyawan</h4>
                ...
                <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="posisi" class="form-select" required>
                            ...
                            <option value="manager" {{ $pegawai->posisi == 'manager' ? 'selected' : '' }}>Manager</option>
                            <option value="supervisor" {{ $pegawai->posisi == 'supervisor' ? 'selected' : '' }}>Supervisor</option>
                            <option value="staff" {{ $pegawai->posisi == 'staff' ? 'selected' : '' }}>Staff Administrasi</option>
                            <option value="developer" {{ $pegawai->posisi == 'developer' ? 'selected' : '' }}>Web Developer</option>
                        </select>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary btn-update">Update Data</button>
                    </div>
